...
function Header() {
  ...
  return (
    <header className="border-b text-xl bg-gradient-to-r from-indigo-50 to-purple-200  min-h-[60px] px-10 py-3 relative tracking-wide relative z-50 font-handwriting">
