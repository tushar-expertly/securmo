    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            The Securmo website contains documents and resources contributed by
          ...
          <p className="mb-4">
            ...
            While we strive to ensure accuracy and currency, Securmo does not
            guarantee the reliability or authenticity of third- party
            information. Securmo disclaims any liability for actions taken based
            on the information presented, as well as any consequences arising
            from such actions.
          </p>
          ...
          <p className="mb-4">
            Securmo’s web portal may feature links to external websites managed
            ...
            imply endorsement of the external site or its content. Securmo may
            remove or update links at any time without prior notice. For
            concerns about linked external websites, please contact the
            respective organizations. Securmo is not responsible for the content
            of external websites.
          </p>
          <p className="mb-4">
            If you encounter issues with linked external websites, please
            contact the respective organization. Securmo is not responsible for
