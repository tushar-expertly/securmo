          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div className="max-w-lg">
              ...
              <p className="mt-4 text-gray-600 text-lg">
                At Securmo, we believe in the transformative power of education.
                Our mission is to empower individuals and organizations
                worldwide through high-quality online training programs designed
      ...
      <div className="bg-gray-100  flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-8xl w-full space-y-8">
          <div className="bg-gray-100 shadow-md rounded-lg p-8">
            ...
            <h3 className="text-2xl text-gray-700 text-center mb-8">Securmo</h3>
            <div className="space-y-6">
              <div>
                <h4 className=" text-gray-800">Who We Are</h4>
                <p className="mt-2 text-gray-600">
                  Established in 2024,Securmo has quickly become a trusted
              ...
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  At Securmo, excellence is not just a goal; it's our standard.
              ...
              <div>
                ...
                <p className="mt-2 text-gray-600">
                  ...
                  towards achieving your goals with Securmo.
                </p>
              </div>
            </div>
          </div>
